...
def main() -> None:
    ...
    print("    -> angle-independent to numerical precision, as required by the")
    print("       configuration's own spherical symmetry (angularly uniform tau).")
    ...
    print("Angular uniformity                    : CONFIRMED -- spherically symmetric result,")
    print("                                        not an artefact of sampling one direction")
    ...
    print("beta_q/beta_d=sqrt(6)/2 holds IFF the mediator is EXACTLY MASSLESS. Invoking")
    print("mu>0 to explain a nonzero cosmological signal directly conflicts with that")
    print("same derivation UNLESS the mediator is effectively massless at cluster scale")
    print("(where beta_q/beta_d was derived) and effectively massive/screened only")
    print("cosmologically -- a real, scale-dependent self-consistency requirement of")
    print("the chameleon/Vainshtein/symmetron class, NOT checked or assumed here.")
