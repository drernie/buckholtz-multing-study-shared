...
# ---------------------------------------------------------------------------
# Verbatim from TJB's own multing_core.py (same subset P176/P177 already
...
def addot_over_a_eps(z, b1, b2, eps):
    """TJB's own addot_over_a with F0 -> (1+eps)*F0 (FINDING_P165's own
    monopole-tier perturbation, verified faithful in FINDING_P177)."""
