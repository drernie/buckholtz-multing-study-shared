...
def main():
    ...
    print("strength was itself caught and fixed.")
    print()
    print("[USER-FLAGGED PRECISION CORRECTION] A*g^2<~8.39e-12 (SI, Reading 1)")
    print("is a SOFT/CONDITIONAL CEILING UNDER AN EXPLICIT MAPPING -- NOT a")
    print("direct experimental measurement of MULTING's own A*g^2. It applies")
    print("to the SAME A*g^2 that FINDING_P52 (this session) proved is the")
    print("field-redefinition-invariant force-strength combination -- though A")
    print("plays a conceptually different role in each finding (P21: fixed")
    print("dimensional constant; P52: free redefinition parameter). Both")
    print("conventions give the same invariant, and the constraint transfers")
    print("either way, carrying the SAME mapping-not-measurement caveat.")
    print()
    print("This is, in the specific sense P50B/P51/P52 each said was missing,")
    print("a genuine EXTERNAL SCALE CONSTRAINT: it comes from an independently-")
    print("published paper's fifth-force bound (a DIFFERENT physical mechanism")
    print("entirely -- DM-only coupling, not MULTING's own universal coupling,")
    print("per FINDING_P22 section 3), not from this project's own internal")
    print("rank/nullspace or dimensional-covariance machinery. That external-")
    print("ness is real; its precision and direct applicability are not.")
    print()
