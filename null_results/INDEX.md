...
| NR-018 | 2026-08-03 | naive-pair-fluid-virial-mapping | REJECT | positive-density virial mapping of U~r^-n gives w=n/3, so no dark-energy EoS; Omega_pair ~1e-6 (amplitude is cutoff-dependent, C3 is not). SCOPE: closes ONE mapping, NOT generalized Layzer-Irvine, NOT all bridges |
